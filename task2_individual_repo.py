...
for branch in branches:
    ...
    if branch_name =='main':
        ...
        grouped_list.append({"repo name" :repo_name_list[select_repo]})
        grouped_list.append({"Author of the Main":author_name})  
        grouped_list.append({"Path of the branch that are stale":delete_branches})
